...
namespace Sample22
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private AdsStream BlockRead(VariableInfo[] variables)
        {
            ...
            adsClient.ReadWrite((uint)0xF080, (uint)variables.Length, rdStream, (AdsStream)writer.BaseStream);
        ...
        private AdsStream BlockRead2(VariableInfo[] variables)
        {
            ...
            AdsStream rdStream = new AdsStream(rdLength);
            adsClient.ReadWrite((uint)0xF081, (uint)variables.Length, rdStream, (AdsStream)writer.BaseStream);
