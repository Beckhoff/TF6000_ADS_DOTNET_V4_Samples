    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void Form1_Load(object sender, System.EventArgs e)
		{
            ...
            using (binRead = new AdsBinaryReader(dataStream))
            {
                ...
                tcClient = new TcAdsClient(); // Don't forget to dispose when finish using

                // Leaving Synchronized on the new Default 'False' to demonstrate Notification synchronization
                tcClient.Synchronize = false;
                ...
                try
                {
                    ...
                    hConnect[6] = tcClient.AddDeviceNotification("MAIN.stringVal", dataStream, 20, 13,
